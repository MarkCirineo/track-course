...
import { Bookmark, BookmarkCheck, Star, StarOff, CircleCheck, PlusCircle, FileText } from "lucide-react";
          ...
          >
            ...
            <CardHeader className="pb-2">
              <div className="flex items-start justify-between gap-2">
                <h2 className="font-semibold leading-tight pr-8">
                  {course.displayName}
                </h2>
